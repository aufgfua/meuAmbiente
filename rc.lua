...
-- ------------------------------------FAZER OS AVISOS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    awful.key({ modkey,           }, "F1", function () awful.spawn("firefox") end,
              {description = "start firefox", group = "programs"}),
    awful.key({ modkey,   "Shift"        }, "F1", function () awful.spawn("firefox --private-window") end,
              {description = "start private firefox", group = "programs"}),


    awful.key({ modkey,           }, "F2", function () awful.spawn("subl") end,
              {description = "start sublime", group = "programs"}),

        awful.key({ modkey,           }, "F3", function () awful.spawn("netbeans") end,
              {description = "start netbeans", group = "programs"}),

        awful.key({ modkey,           }, "q", function () awful.spawn("thunar") end,
    ...
    awful.key({ modkey, "Shift" }, "i", function() awful.util.spawn("sh /home/arch/Desktop/scripts/ambienteDev2.sh") end,
              {description = "start dev env gamificacao", group = "launcher"}),
